...
public class guiProductionCalc extends guiCommon {
    ...
    private static final int TAB_NUM = 0;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        // main panel
        //drawRect(gx, gy, gx + GUI_WIDTH, gy + gui_height, 0xFF202020);
        drawSolidPanel(this.gx, this.gy + TAB_H, GUI_WIDTH, this.gui_height - TAB_H, 0xFFC6C6C6);
    }
}
